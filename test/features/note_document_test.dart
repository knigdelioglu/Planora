...
void main() {
  test('note document round-trips supported blocks', () {
    final doc = NoteDocument(version: 1, blocks: <NoteBlock>[
      const NoteBlock(id: '1', type: NoteBlockType.heading, text: 'Başlık', level: 2),
      const NoteBlock(id: '2', type: NoteBlockType.checkbox, text: 'Görev', checked: true),
      const NoteBlock(id: '3', type: NoteBlockType.link, text: 'OpenAI', url: 'https://openai.com'),
    ]);
  ...
  test('unknown blocks are preserved instead of corrupting the note', () {
    final raw = jsonEncode(<String, Object?>{
      'version': 99,
      'blocks': <Object?>[<String, Object?>{'id': 'future', 'type': 'futureWidget', 'payload': <String, Object?>{'x': 1}}],
    });

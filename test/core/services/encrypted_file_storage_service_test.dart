...
void main() {
  ...
  test('persistent attachment bytes are encrypted and materialize losslessly', () async {
    ...
    final List<int> persistedBytes = await File(stored.localPath).readAsBytes();
  ...
  test('legacy plaintext attachment is encrypted during reconciliation lookup', () async {

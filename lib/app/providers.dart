...
final Provider<AppServices> appServicesProvider = Provider<AppServices>(
  (ref) => AppServiceRegistry.current,
);
final notesRepositoryProvider = Provider<NotesRepository>(
  (ref) => ref.watch(appServicesProvider).notes,
);
...
final remindersRepositoryProvider = Provider<RemindersRepository>(
  (ref) => ref.watch(appServicesProvider).reminders,
);
...
final notificationServiceProvider = Provider<NotificationService>(
  (ref) => ref.watch(appServicesProvider).notifications,
);
final filePickerServiceProvider = Provider<FilePickerService>(
  (ref) => ref.watch(appServicesProvider).filePicker,
);
final syncCoordinatorProvider = Provider<SyncCoordinator>(
  (ref) => ref.watch(appServicesProvider).syncCoordinator,
);
final syncQueueRepositoryProvider = Provider<SyncQueueRepository>(
  (ref) => ref.watch(appServicesProvider).syncQueue,
);
final settingsRepositoryProvider = Provider<AppSettingsRepository>(
